...
module.exports.run = async (bot, message, args) => {
  ...
  let cmd = messageArray[0].toLocaleLowerCase();
    ...
    if(cmd === `${prefix}tempdeafen`) {
        ...
        if(dUser.highestRole.position >= message.member.highestRole.position) return message.channel.send("YOU CANNOT DEAFEN A MEMBER WHO HAS HIGER OR HAS SAME ROLE AS YOU**!**");
