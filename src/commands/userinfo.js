...
module.exports.run = async(bot, message, args) => {
    ...
    .addField("Created", moment(user.createdAt).format("ddd DD MMM YYYY HH:mm [UTC]").toUpperCase())
    .addField("Joined", moment(member.joinedAt).format("ddd DD MMM YYYY HH:mm [UTC]").toUpperCase())
